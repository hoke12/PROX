...
TOKEN = '7051424485:AAH2hdM3zDPZIsYUMggUfdLzmrEV4OgRybM'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002239547441
CHANNEL_ID = -1002239547441
error_channel_id = -1002239547441
...
def send_welcome(message):
    ...
    markup.add(btn2, btn4, btn5)

    bot.send_message(message.chat.id, "*START TO HOGYA DDOS AAPKA PAR FREE HAI YARR USE KRO AND ENJOY BAS EK BAAT KA DHYAN RAKHNA USE UPDATE FILES*", reply_markup=markup, parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Contact @LailaModsOwner*", parse_mode='Markdown')
